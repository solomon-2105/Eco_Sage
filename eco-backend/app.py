...
# — Hard-coded Gemini API key —
genai.configure(api_key=".....")  # Ensure your API key is here
...
You are a sustainability expert. Analyze the environmental impact of this product description.
Respond with:
1. Eco-Friendliness Score (1–5)
2. Main environmental concerns
3. 3. If the eco-friendliness score is below 5, provide direct links to alternative products with better sustainability and environmental impact.
